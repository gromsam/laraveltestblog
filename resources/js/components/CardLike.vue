<template>
    <div @click="countPlus" class="icon_count d-flex justify-content-between align-items-center gap-5 fw-bold">
...
export default{
    ...
    methods: {
        ...
        countPlus(){
            axios.post('/article_like', {
                ...
                if(response.data.new_count_like){
                    this.countlike = response.data.new_count_like;
                }
            });
        }
    ...
    mounted(){
        console.log('post_id', this.count);
    }
}
